...
<body>
  ...
  <div class="form-group">
	<label class="col-md-2 control-label" for="password">Pasirinkite darbuotoją, kurio darbo valandų ataskaitą norite matyti:</label>
    <div class="col-md-2">
  ...
  <div class="col-md-2">
    <div class="form-group">
      <div class="col-md-2 text-center">
        <button type="button" class="btn btn-default" id="getData1">Gauti duomenis</button>
      </div>
    </div>
  </div>
  </div>
