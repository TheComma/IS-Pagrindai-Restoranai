...
echo $klientas;
$query = "SELECT rezervacija.data, rezervacija.zmoniu_skaicius,rezervacija.komentarai,rezervacijos_valandos.valandos,restoranas.adresas,restoranas.miestas,rezervacija.id FROM rezervacija,rezervacijos_valandos,restoranas WHERE rezervacija.fk_klientas = '$klientas' AND fk_busena = 1 AND rezervacija.fk_valandos = rezervacijos_valandos.id AND rezervacija.fk_restoranas = restoranas.id ORDER BY rezervacija.data ASC";
